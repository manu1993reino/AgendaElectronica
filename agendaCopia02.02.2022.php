...
if(isset($_SESSION["usuario"])){
    ...
    $tabla=$conn->query("SELECT * FROM agenda LIMIT $principioLimit, $registrosPagina;");
                ...
                echo "<td><input class='btnAceptar' type='submit' name='btnModificar' value='Aceptar'></td>
                    ...
                    <td>
                        <form action='borrar.php' method='post'>
                            <input type='hidden' value='".$dato['codigo']."' name='check'>
                            <input type='checkbox' name='borarVarios' value='Borrar Varios'>
                        </form>
                    </td>";
            }
            else{
        ...
        echo  "<form method='post' id='codigosVarios' action='borrar.php'>";
        print_r($tabla);
        foreach($tabla as $dato){
            echo "hola";
            echo  "<td>";
            echo  "<input type='checkbox' name='checkboxvar[]' value='".$dato["codigo"]."'>";
            echo  "</td>";
        }
        echo "</form>";
        echo  "<button type='submit' form='codigosVarios' name='borrarVarios'>Enviar</button>";
    }
